import{_ as i,r as p,o,c,a as n,d as s,b as a,e as t}from"./app-446c8cc2.js";const d={},l=n("h1",{id:"pdf",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#pdf","aria-hidden":"true"},"#"),s(" PDF")],-1),r=n("h2",{id:"_1、加密、解密",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1、加密、解密","aria-hidden":"true"},"#"),s(" 1、加密、解密")],-1),u={href:"https://mp.weixin.qq.com/s/YOxBzYPMqfl5gCAWtnVXKA",target:"_blank",rel:"noopener noreferrer"},m=t(`<p><strong>加密</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># 导入这个库</span>
